  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (e.code !== 'auth/popup-closed-by-user') {
        setError(e.code || e.message || 'Неизвестная ошибка')
      }
      setLoading(false)
    }
  }

  // Пока Firebase проверяет сессию — пустой экран
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-soil-100">
      <div className="card p-10 w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-semibold text-green-800 mb-2">Виртуальная теплица</h1>
        <p className="text-sm text-gray-500 mb-8">Ведите цифровой дневник своей теплицы</p>
